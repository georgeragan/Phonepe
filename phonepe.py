...
def top_chart_transaction_amount(table_name):
    ...
    col1,col2=st.columns(2)
    with col1:
        fig_amount=px.bar(df_1,x="states",y="transaction_amount",title="TRANSACTION AMOUNT",hover_name="states",color_discrete_sequence=px.colors.sequential.Agsunset_r)
        st.plotly_chart(fig_amount)
...
def top_chart_registered_users(table_name):
    ...
    with col2:
        ...
        fig_amount_2= px.bar(df_2, x="states", y="registereduser", title="LAST 10 REGISTERED USER", hover_name= "states",
                            color_discrete_sequence=px.colors.sequential.Aggrnyl_r, height= 650,width= 600)
        st.plotly_chart(fig_amount_2)
...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\AMALA SALI\Desktop\Phonepe\Phonepe\download.png"),width= 400)
